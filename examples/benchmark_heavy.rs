use limcode::{deserialize_bincode, deserialize_bincode_unchecked, serialize_bincode};
...
fn main() {
    ...
    for (size, name, iterations) in sizes {
        ...
        println!(
            "│ Limcode     │ {:>5}ns │ {:>5}ns │ {:>5.1}ns │ {:>5}ns │ {:>5}ns │ {:>5}ns │",
            limcode_enc.min_ns,
            limcode_enc.max_ns,
            limcode_enc.avg_ns,
            limcode_enc.median_ns,
            limcode_enc.p95_ns,
            limcode_enc.p99_ns
        );
        ...
        println!(
            "│ Wincode     │ {:>5}ns │ {:>5}ns │ {:>5.1}ns │ {:>5}ns │ {:>5}ns │ {:>5}ns │",
            wincode_enc.min_ns,
            wincode_enc.max_ns,
            wincode_enc.avg_ns,
            wincode_enc.median_ns,
            wincode_enc.p95_ns,
            wincode_enc.p99_ns
        );
        ...
        println!(
            "│ Bincode     │ {:>5}ns │ {:>5}ns │ {:>5.1}ns │ {:>5}ns │ {:>5}ns │ {:>5}ns │",
            bincode_enc.min_ns,
            bincode_enc.max_ns,
            bincode_enc.avg_ns,
            bincode_enc.median_ns,
            bincode_enc.p95_ns,
            bincode_enc.p99_ns
        );
        ...
        println!(
            "│ Limcode UC  │ {:>5}ns │ {:>5}ns │ {:>5.1}ns │ {:>5}ns │ {:>5}ns │ {:>5}ns │",
            limcode_unchecked.min_ns,
            limcode_unchecked.max_ns,
            limcode_unchecked.avg_ns,
            limcode_unchecked.median_ns,
            limcode_unchecked.p95_ns,
            limcode_unchecked.p99_ns
        );

        println!("└─────────────┴────────┴────────┴────────┴────────┴────────┴────────┘");

        let speedup_vs_safe = limcode_dec.avg_ns as f64 / limcode_unchecked.avg_ns as f64;
        let speedup_vs_wincode_unchecked =
            wincode_dec.avg_ns as f64 / limcode_unchecked.avg_ns as f64;
        ...
        println!(
            "Saved: {:.1}ns by removing bounds checks",
