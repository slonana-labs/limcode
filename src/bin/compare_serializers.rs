...
fn main() {
    ...
    for (num_elements, name, iterations) in configs {
        let data: Vec<u64> = (0..num_elements).map(|i| 0xABCDEF0123456789u64 + i as u64).collect();
        ...
        // Bincode
        {
            ...
            println!("| {:6} | bincode | {:16.2} | {:18.2} |", name, ser_gbps, deser_gbps);
        }
        ...
        // Wincode
        {
            ...
            println!("| {:6} | wincode | {:16.2} | {:18.2} |", name, ser_gbps, deser_gbps);
        }
    }
