...
fn test_u64_vec_1kb() {
    ...
    assert_eq!(wincode_bytes, limcode_bytes, 
               "Vec<u64> 1KB mismatch: wincode {} bytes, limcode {} bytes",
               wincode_bytes.len(), limcode_bytes.len());
}
